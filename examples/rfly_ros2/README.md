...
- 蓝色车辆 ID 101 是目标车辆，沿闭合路点路线高速行驶，使用受加速度、制动、横摆角速度和最小转弯半径约束的前向运动学，并周期变速。
...
天气预设保留 Rfly WeatherController 和视觉压力层。有效雨风演示使用 Rfly 强风类型 1 加视觉雨滴、雾化、模糊和周期遮挡；官方雨类型 5 在部分重启状态会导致黑屏，因此黑屏/静帧不作为有效视频。
